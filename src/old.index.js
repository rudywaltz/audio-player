...
function mousePressed() {
  ...
  if (!audioContext) {
    ...
    audio.addEventListener(
      ...
      audio.src = "https://mcdn.podbean.com/mf/download/gn47rt/20220207_versek_szvazifoldilakopark_zuhanasgatlotestheveder.mp3";
...
//   document.querySelector("#playButton").addEventListener("click", mousePressed)
// })
