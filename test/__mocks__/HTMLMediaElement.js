if(!global.window.HTMLMediaElement.prototype._mock) {
  global.window.HTMLMediaElement.prototype._mock = {
    ...
    _load: function audioInit(audio) {
      ...
      audio.dispatchEvent(new Event('canplaythrought'))
    },
  ...
  // Get and set audio src
  Object.defineProperty(global.window.HTMLMediaElement.prototype, 'src', {
    get() {
